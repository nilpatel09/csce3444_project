...
from email import message, message_from_binary_file, message_from_bytes
...
# import elements of libraries

from tkinter import Image, messagebox as mess
...
def TakeImages():
    ...
    if (name.isalpha()) or (' ' in name):
        ...
        with open('StudentDetails\StudentDetails.csv', 'a+') as csvFile:
            ...
            writer.writerow(row)
        csvFile.close()
        message_from_bytes.configure(text=res)
    else:
...
def TrainImages():
    ...
    message_from_binary_file.configure(text=res)
...
# tkinter window design [GUI]
window = tk.Tk()
window.geometry("1280x720")
window.resizable(True, False)
window.title("Attendance Management System (#creativeone.com)")
...
message3 = tk.Label(window, text="Face Recognition Based Attendance Management System", fg="white", bg="#262523",
...
datef = tk.Label(frame4, text=day_abbr + "-" + month_abbr[month] + "-" + year + "  |  ", fg="orange", bg="#262523", width=55,
...
takeImg = tk.Button(frame2, text="Take Images", command=TakeImages, fg="black", bg="#F5FD03", width=34, height=1,
                    activebackground="white", font=('times', 15, ' bold '))
takeImg.place(x=30, y=300)
trainImg = tk.Button(frame2, text="Save Profile", command=psw, fg="black", bg="#F5FD03", width=34, height=1,
                     activebackground="white", font=('times', 15, ' bold '))
trainImg.place(x=30, y=380)
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages, fg="black", bg="#1AFD03", width=35, height=1,
                     activebackground="white", font=('times', 15, ' bold '))
